  ...
  return (
    <div>
      ...
      <div className='max-w-[90%] bg-violet-800 rounded-b-2xl relative container mx-auto'>
        ...
        <div className='bg-[rgba(255,255,255,1)] border-2 border-white rounded-2xl absolute -bottom-70 md:left-1/2 md:-translate-x-1/2 p-4 text-center w-fit'>
          
          <div className='h-[400px] text-black max-w-[700px]'>
